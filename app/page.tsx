    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-white p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div className="flex flex-col items-center">
          <Image src="/laundry1.jpg" alt="Laundry 1" width={300} height={200} className="rounded-lg shadow-md mb-2" />
          <span className="text-sm text-gray-500">Easy laundry, happy results</span>
        </div>
        <div className="flex flex-col items-center">
          <Image src="/laundry2.webp" alt="Laundry 2" width={300} height={200} className="rounded-lg shadow-md mb-2" />
          <span className="text-sm text-gray-500">Enjoy the freshness</span>
        </div>
        <div className="flex flex-col items-center">
          <Image src="/laundry3.webp" alt="Laundry 3" width={300} height={200} className="rounded-lg shadow-md mb-2" />
          <span className="text-sm text-gray-500">Modern, efficient machines</span>
        </div>
      </div>
      <ChatDashModal />
    </div>
